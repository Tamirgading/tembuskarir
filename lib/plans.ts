...
export const DEFAULT_PLANS: Record<string, PlanConfig> = {
  premium_monthly: {
    ...
    period: '/ bulan',
    description: 'Akses simulasi seleksi: ASTRA lengkap, RBB BUMN, PLN (GAT + 1 Bidang Akademik pilihan), dan ANTAM (1 Job Stream pilihan)',
    features: [
      'Psikotes ASTRA (semua paket)',
      'RBB BUMN Tahap 1 & 2',
      'PLN GAT + 1 Bidang Akademik pilihan',
      'ANTAM IMPACT (1 Job Stream pilihan)',
      'Pembahasan lengkap, analisis skor, perankingan & distribusi nilai',
    ],
    badge: 'Populer',
    highlight: true,
    isActive: true,
