  ...
  return (
    <div className="min-h-screen text-slate-800 antialiased relative overflow-x-hidden flex items-center justify-center p-4 sm:p-6"
      style={{
        ...
        backgroundImage: `
          radial-gradient(at 15% 15%, rgba(155, 225, 253, 0.45) 0px, transparent 55%),
          radial-gradient(at 85% 85%, rgba(56, 154, 221, 0.25) 0px, transparent 50%),
          radial-gradient(at 50% 30%, rgba(240, 247, 255, 0.8) 0px, transparent 65%)
        `
      }}
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0" 
        style={{
          ...
          backgroundImage: `
            linear-gradient(to right, rgba(22, 72, 126, 0.04) 1px, transparent 1px),
            linear-gradient(to bottom, rgba(22, 72, 126, 0.04) 1px, transparent 1px)
          `
        }}
      ></div>

      {/* Desktop App Background Mockup */}
      <div className="absolute inset-0 z-0 flex flex-col justify-between p-6 md:p-10 pointer-events-none select-none">
        <header className="flex items-center justify-between max-w-7xl mx-auto w-full opacity-60">
          <div className="flex items-center gap-3">
            <img alt="TembusKarir Logo" className="w-8 h-8 object-contain" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBVfvFccj0ls3XZSeP2rVHeGvD20behMlru3Wc5iZo5s-ahETznu0B3JQw7O_KXXoaCXMpBOsU-hHzqDQhsRBF-z25QyOdh9VysLL5kmxUmGyX2VchjfWOQMYZ1hmuc-h_4T7Ir9H7Wr2JUFHpmjBs1ugWniq1Ehv_bebsXFwIUGtH4IMomLaWXZu1FIFT4Z1oD2Bw_0BvIJcRg-cYuq9FqOINi6hZEnBogNmXT9CEJHcSNb2U26ghpFvLsTtkqlrtAIA"/>
            <span className="text-xl font-extrabold tracking-tight text-brand">TEMBUSKARIR</span>
          </div>
        ...
        <footer className="max-w-7xl mx-auto w-full flex items-center justify-between text-xs text-slate-400 opacity-60">
      ...
      {/* Modal Card Shell */}
      <div className="relative w-full max-w-[480px] bg-white rounded-3xl p-6 sm:p-8 shadow-modal border border-slate-100 transition-all duration-300 z-10">
        ...
        <div className="flex items-start justify-between mb-6 pt-1">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h2 className="text-2xl font-bold tracking-tight text-slate-900 leading-tight">Masuk</h2>
