        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-3">
              <a className="text-sm font-semibold text-[#16487e] hover:text-[#389add] px-4 py-2 rounded-xl transition-colors" href="#masuk">
                Masuk
              </a>
              <a className="inline-flex items-center justify-center text-sm font-bold text-white bg-[#16487e] hover:bg-[#389add] px-6 py-2.5 rounded-full shadow-md shadow-[#16487e]/20 hover:shadow-lg transition-all duration-200" href="#daftar">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10 pt-4 pb-2">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-base font-extrabold text-white bg-[#16487e] hover:bg-[#389add] rounded-full shadow-lg shadow-[#16487e]/25 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200" href="#daftar">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-[#16487e] to-[#0f355c] text-white p-8 sm:p-12 md:p-14 text-center relative overflow-hidden shadow-2xl border border-[#9be1fd]/20">
              ...
              <div className="relative z-10 max-w-2xl mx-auto space-y-6">
                ...
                <div className="pt-4 flex flex-wrap justify-center gap-4">
                  <a className="px-8 py-4 bg-[#389add] hover:bg-[#9be1fd] hover:text-[#16487e] text-white font-extrabold rounded-full shadow-lg shadow-[#389add]/30 hover:scale-105 transition-all text-base" href="#daftar">
