...
export default async function BumnTahap1Page() {
      ...
      <div className="rounded-2xl overflow-hidden border border-hairline shadow-soft">
        <div className="px-6 py-7 text-white" style={{ background: 'linear-gradient(135deg,#0F2C44,#0a1f30)' }}>
          <nav className="flex items-center gap-2 text-xs text-white/50 mb-4">
            ...
            <span>›</span>
            <span className="text-white/80">Tahap 1</span>
          </nav>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <p className="text-white/55 text-xs font-semibold uppercase tracking-wider">BUMN Tahap 1</p>
              <h1 className="text-2xl font-heading font-extrabold">TKD · AKHLAK · TWK</h1>
            </div>
          </div>
          <p className="text-white/60 text-sm">
            Simulasi Tes Online Tahap 1 RBB BUMN: TKD (VLR · NS · WC · DIAG), AKHLAK, dan TWK dengan passing grade seperti tes aslinya.
          </p>
        </div>
      </div>
